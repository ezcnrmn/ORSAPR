...
namespace KompasWrapper
{
    ...
    public class SelfTappingScrewBuilder
    {
            ...
            SelfTappingScrewParameters selfTappingScrewParameters)
        {
            ...
            DrawHexagon(kompas3DWrapper, selfTappingScrewParameters.HeadDiameter, 
                iDefinitionSketch);
            ...
            double slopeLength =
                ...
                Math.Sin(angle70Radians) /
                Math.Sin(angle20Radians);
            ...
            double tipLength = 
                selfTappingScrewParameters.InternalThreadDiameter / 
                2 * Math.Sin(angle75Radians) /
                Math.Sin(angle15Radians);
            DrawRod(selfTappingScrewParameters, iDefinitionSketch2, 
                slopeLength, tipLength);
            ...
            double tipRadius = tipLength2 * Math.Sin(angle15Radians) / 
        ...
        private void DrawTriangle(SelfTappingScrewParameters parameters, 
            ksSketchDefinition iDefinitionSketch, double tipLength)
        {
            ...
            rodDocument2D.ksLineSeg(parameters.InternalThreadDiameter / 2,
                ...
                parameters.RodLength - tipLength - triangleBase / 2,
                1);
            rodDocument2D.ksLineSeg(parameters.ThreadDiameter / 2,
                parameters.RodLength - tipLength - triangleBase / 2,
                parameters.InternalThreadDiameter / 2,
                parameters.RodLength - tipLength - triangleBase,
                1);
            rodDocument2D.ksLineSeg(parameters.InternalThreadDiameter / 2,
                parameters.RodLength - tipLength - triangleBase,
                parameters.InternalThreadDiameter / 2,
        ...
        private void MakeThread(Kompas3DWrapper kompas3DWrapper, 
            SelfTappingScrewParameters parameters, double slopeLength, 
            double tipLength, double tipLength2, double tipRadius)
        {
            ...
            ksSketchDefinition iDefinitionTriangleSketch = 
                (ksSketchDefinition)iTriangleSketch.GetDefinition();
            ...
            iCylindricSpiralDefinition.height = 
        ...
        private void RotationOperation(Kompas3DWrapper kompas3DWrapper, 
            ksEntity entitySketch, ksSketchDefinition definitionSketch)
        {
        ...
        /// <param name="tipLength">Длина кончика</param>
        private void DrawRod(SelfTappingScrewParameters parameters, 
            ksSketchDefinition iDefinitionSketch, double slopeLength, double tipLength) 
        {
            ...
            rodDocument2D.ksLineSeg(0.0,
                parameters.RodDiameter / 2,
                parameters.RodLength - parameters.ThreadLength,
                parameters.RodDiameter / 2,
                1);
            // линия уклона
            rodDocument2D.ksLineSeg(parameters.RodLength - parameters.ThreadLength,
                parameters.RodDiameter / 2,
                parameters.RodLength - parameters.ThreadLength + slopeLength,
                parameters.InternalThreadDiameter / 2,
                1);
            // линия длины резьбы
            rodDocument2D.ksLineSeg(parameters.RodLength - parameters.ThreadLength + slopeLength,
                ...
                1);
            // линия кончика
            // rodDocument2D.ksLineSeg(parameters.RodLength - tipLength,
            // parameters.InternalThreadDiameter / 2, parameters.RodLength, 0.0, 1);
            rodDocument2D.ksArcBy3Points(parameters.RodLength - tipLength,
                parameters.InternalThreadDiameter / 2,
                parameters.RodLength - (tipLength * 0.9),
                parameters.InternalThreadDiameter / 2.07,
